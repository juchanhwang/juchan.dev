...
date: "2019-02-01"
description: "쉽게 말하면 문제가 있는 패턴이나 코드를 찾기 위해 사용되는 정적 분석 툴이다."
tags: ["Development"]
draft: false
---
...
>
> 출처: [https://eslint.org/docs/about/](https://eslint.org/docs/about/)
...
> 참조: [https://velog.io/@velopert/eslint-and-prettier-in-react](https://velog.io/@velopert/eslint-and-prettier-in-react)

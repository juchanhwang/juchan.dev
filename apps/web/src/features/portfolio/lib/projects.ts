...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      problemLink: {
        title: "유저 인터뷰 전문 보기",
        href: "/projects/missionary/docs/user-interview",
      },
      asIsTable: [
        {
          task: "등록 신청",
      ...
      roadmap: [
        ...
        { label: "유저 인터뷰 — 준비팀원 문제 검증", status: "done" },
        { label: "권한 세분화 — 준장·준비팀·대원 레벨별 접근 제어", status: "in-progress" },
        { label: "등록 쿼터 관리 — 팀별 정원 설정 + 선착순 현황 공개", status: "planned" },

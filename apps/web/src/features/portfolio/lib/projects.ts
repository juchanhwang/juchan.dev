...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      resultContent:
        "6개 이상의 외부 도구에 분산되어 있던 선교 운영 워크플로우를 통합하는 어드민 시스템을 구축했습니다. 현재 선교 관리, 등록 관리, 유저 관리, 연계지 관리 기능이 구현되어 운영 중이며, 사용자 앱과 추가 기능은 계속 확장해 나가고 있습니다. pnpm 모노레포로 4개 패키지를 일관되게 관리하며, 18개 DB 모델과 25개 디자인시스템 컴포넌트로 확장 가능한 구조를 갖추었습니다.",
      screenshots: [
        {
